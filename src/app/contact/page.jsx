  ...
  return (
    <>
      <motion.div
        ...
        className='min-h-[80vh] w-full h-max md:w-10/12 md:max-w-screen-xl self-center grid grid-cols-1 lg:grid-cols-2 gap-0 md:gap-20 justify-center place-items-center mt-[80px] mb-10 lg:mb-0'
      >
        <Image
