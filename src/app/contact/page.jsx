    ...
    <>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-10 text text-gray-500 dark:text-yellow-50 text-md md:text-lg p-5 mb-10 md:mt-10 md:p-0'>
          <motion.span initial={{ opacity: 0, y:10 }} whileInView={{ opacity: 1, y:0 }} transition={{duration: 2, type:"spring"}} className='text font-bold text-start border-4 border-b-[20px] border-r-[20px] dark:border-0 border-gray-700 p-5 bg-white dark:bg-neutral-700 dark:border-yellow-50 dark:rounded-2xl rounded-sm shadow-xl'>
            <span className='text text-2xl text-blue-500'>Contact Me At: <br/><br/></span>
            <span className='text text-red-400'>Email: </span>
            <a href='ma&#105;lto&#58;prajw&#97;%6Cdhun%67an&#97;2%30&#64;%6&#55;mai%6C&#46;com' target='_blank'>&#112;rajwaldhung&#97;&#110;a&#50;0&#64;g&#109;&#97;il&#46;c&#111;m</a><br/><br/>
            <span className='text text-red-400'>LinkedIn: </span>
            <a href='https://www.linkedin.com/in/prajwal-dhungana-214248130/' target='_blank'>Prajwal Dhungana </a><br/>
          </motion.span>
          <motion.a href='https://github.com/prajwl-dh' target='_blank' initial={{ opacity: 0, y:10 }} whileInView={{ opacity: 1, y:0 }} transition={{duration: 2, type:"spring"}} className='text font-bold text-start border-4 border-b-[20px] border-r-[20px] dark:border-0 border-gray-700 p-5 bg-white dark:bg-neutral-700 dark:border-yellow-50 dark:rounded-2xl rounded-sm shadow-xl'>
            <span className='text text-2xl text-blue-500'>Github Profile: </span><br/><br/>
          ...
          <motion.a href={'/resumePrajwalDhungana.pdf'} target='_blank' initial={{ opacity: 0, y:10 }} whileInView={{ opacity: 1, y:0 }} transition={{duration: 2, type:"spring"}} className='text font-bold text-start border-4 border-b-[20px] border-r-[20px] dark:border-0 border-gray-700 p-5 bg-white dark:bg-neutral-700 dark:border-yellow-50 dark:rounded-2xl rounded-sm shadow-xl'>
            <span className='text text-2xl text-blue-500'>Resume: </span><br/><br/>
