...
export default function ContactForm() {
  ...
  return (
    <form
      ...
      className='flex flex-col gap-6 xl:gap-5 items-center mx-3 lg:mx-0 p-5 md:p-5 md:pb-2 order-last lg:order-1 border-4 border-b-[20px] border-r-[20px] dark:border-0 border-gray-700 bg-white dark:bg-neutral-700 dark:border-yellow-50 dark:rounded-lg rounded-sm shadow-xl'
    >
