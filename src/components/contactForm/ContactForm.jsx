...
export default function ContactForm() {
  ...
  return (
    <form
      ...
      className='flex flex-col gap-6 xl:gap-5 items-center mx-3 lg:mx-0 p-5 md:p-5 md:pb-2 order-last lg:order-1 bg-white dark:bg-neutral-700 bg-opacity-50 rounded-lg shadow-2xl'
    >
