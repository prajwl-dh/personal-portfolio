  ...
  return (
    <div className='flex flex-row justify-between h-16 p-10 items-center w-screen'>
      ...
      <div className='flex flex-row gap-10 text-gray-500 dark:text-yellow-50 text-lg hover:cursor-pointer font-bold items-center'>
        ...
        <Link className={`hover:text-gray-800 hover:underline dark:hover:text-yellow-200 ${pathName === '/contact' ? 'text-gray-800 underline decoration-4 underline-offset-4 dark:text-yellow-200' : null}`} href='/contact'>Contact</Link>
        {
